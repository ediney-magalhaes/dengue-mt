"""
Backfill histórico Bronze — 2018→atual
...
from src.ingestion.modis import ingerir_bronze as ingerir_modis

if __name__ == '__main__':
    print('=== BACKFILL BRONZE 2018→atual ===')
    ...
    print('\n5. MODIS NDVI/EVI...')
    usuario = input('NASA Earthdata usuário: ')
    senha   = input('NASA Earthdata senha: ')
    ingerir_modis(usuario=usuario, senha=senha, ano_inicio=2018)
